...
const generations=[
 {id:'Gen1',title:'Everyone-OS readiness gate',status:'CI-clean software preparation + human-surface contracts',ready:['graphical shell contract','seven everyday traits contract','intent/accessibility contract','recovery contract','unattended candidate validation','TR8:WEB stable launcher/materializer + acceptance contract','TR8:PROMPT loopback prompt surface + Open Web fallback contract'],held:['TR8:WEB seed/VM + visible render/input acceptance','TR8:PROMPT runtime health/fallback acceptance','Hopper physical boot','Guardian forced rollback','second-architecture usability']},
