...
- [x] Helper selects only one connected `usb0` target.
- [x] Target account is fixed to `boxbrain-link`.
- [x] Address is restricted to `10.12.194.0/24` and excludes the Pi.
- [x] Strict host-key checking and dedicated trust file remain enabled.
