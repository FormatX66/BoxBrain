...
for f in aurum_arcade.py aurum_autonomy.py aurum_console.py aurum_bootstrap.py aurum_driver_synthesis.py aurum_gui_runtime.py aurum_hardware.py aurum_network.py aurum_runtime_update.py aurum_time.py aurum_wifi_diag.py aurum_wifi_recovery.py aurum_workspace.py aurum_installer.py; do
