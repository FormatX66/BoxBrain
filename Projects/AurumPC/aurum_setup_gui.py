...
def _friendly_reason(value: object) -> str:
    ...
    known = {
        ...
        "wifi-driver-unavailable": "The Wi-Fi hardware was found, but its driver is not ready.",
        "network-manager-unavailable": "The network service is not ready. Setup will stay usable offline.",
        "credentials-required": "Choose a Wi-Fi network and enter its password.",
        "invalid-wifi-credentials": "Enter a valid network name and an 8–63 character password.",
        "wifi-credentials-rejected": "That network rejected the password. No saved connection was replaced.",
        "wifi-network-not-found": "That network is not visible to this Wi-Fi adapter.",
        "wifi-association-failed": "The Wi-Fi adapter could not join that network. No saved connection was replaced.",
        "online-cleanup-pending": "Wi-Fi is online. Old Aurum profiles still need safe cleanup.",
        "use-gui-wifi-setup": "Use this Wi-Fi screen to choose a network and enter its password.",
