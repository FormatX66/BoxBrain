...
| FreeRDP pointer and keyboard control | BrainConnect | Native amd64/arm64 artifacts verified; arm64 installed inert; transport-level live run complete | Exact endpoint, NLA/HYBRID, and certificate recheck; target-bound encrypted systemd runtime credentials; bounded pointer, Unicode-text, and fixed allowlisted-key input; all redirections disabled | [Open-lab control](../../BrainConnect/docs/OPEN_LAB.md) |
