...
| Connection capability map | BoxBrain edge agent / controller / Flutter UI | Source complete | Read-only per-transport state and proven dashboard, input, shell, data, video, and audio capability states | [Connection lifecycle](ConnectionLifecycle.md) |
