...
| FreeRDP observation | BrainConnect | Native certificate helper built and synthetic-tested; host installation and live lab pending | Fixed, out-of-process, certificate-pinned NLA/HYBRID RDP probe | [Native helper](../../BrainConnect/plugins/rdp-observer/native/README.md) |
