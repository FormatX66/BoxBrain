...
| FreeRDP observation | BrainConnect | Native helper installed and synthetic-tested on the Kali Pi 4; controller deployment and live Windows lab pending | Fixed, out-of-process, certificate-pinned NLA/HYBRID RDP probe | [Native helper](../../BrainConnect/plugins/rdp-observer/native/README.md) |
