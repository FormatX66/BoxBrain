...
| FreeRDP pointer and keyboard control | BrainConnect | Persistent sequence artifact installed inert; transport verified; Windows session binding blocked | Exact endpoint, NLA/HYBRID, and certificate recheck; target-bound encrypted systemd credentials; bounded pointer, text, key, and multi-step keyboard input; all redirections disabled | [Open-lab control](../../BrainConnect/docs/OPEN_LAB.md) |
